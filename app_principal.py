...
from components.header import desenhar_header  # <-- IMPORTA O NOSSO NOVO COMPONENTE
...
# 2. DESENHA O TOPO DA LOGCARE (Chama a função do arquivo isolado)
# Você pode mudar a cor oficial da marca direto no parâmetro se desejar!
desenhar_header(cor_da_empresa="#069782", caminho_logo="logo.png")

# 3. MENSAGEM DE AUTONOMIA
st.info(
...
# st.title("🖥️ Central de Sistemas e Processos")
st.subheader("Guia rápido de acessos e documentações para a gestão.")
st.markdown("---")  # Cria uma linha horizontal de separação

# 6. DIVIDINDO A TELA EM COLUNAS (Assim como blocos do PowerPoint!)
# Vamos criar duas colunas grandes para separar as áreas
...
with col_operacao:
    ...
    with st.expander("🏷️ Sistema de QR Code (Atendimento / Planejamento)"):
        ...
        st.write("**Responsável Principal:** Atendimento")
    ...
    with st.expander("🏷️ Sistema de Gestão Ortobom (Transporte / Planejamento)"):
        ...
        st.write("**Responsável Principal:** Transporte")
        st.write("**Suporte Técnico:** Paulo")
        st.info("💡 *Este sistema pode ser acessado de qualquer computador ou celular com internet.*")

    # Sistema 4: WMS & TMS (Sistemas Locais!)
...
with col_financeiro:
    ...
    # Sistema 5: Gerador de Propostas
    ...
    # Sistema 6: Power BI (Sinalizando o futuro para o gestor)
    with st.expander("📊 Power BI (Painéis de Gestão)"):
        ...
        st.write("**Responsável Principal:** Planejamento")
        st.write("**Suporte Técnico:** Paulo")